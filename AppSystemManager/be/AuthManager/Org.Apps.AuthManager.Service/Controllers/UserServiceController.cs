...
namespace Org.Apps.AuthManager.Service.Controllers
{
    ...
    public class UserServiceController : BaseApiController
    {
        ...
        [PerformanceLoggingAdvice]
        public override System.Net.Http.HttpResponseMessage LogGetZipFileList(AppsLogFileRequest logFileRequest)
        {
