...
namespace Org.Apps.LicenseManager.Service
{
    public sealed class LicenseWrapper
    {
        ...
        static AppsLicense _License = null;
        public static AppsLicense License { get { return _License; } }
        ...
        public static void Validate()
        {
            ...
            if (!File.Exists(LicenseBasePath + "pub_Org.pem"))
                if (File.Exists(binPath + "\\pub_Org.pem"))
                    File.Copy(binPath + "\\pub_Org.pem", LicenseBasePath + "pub_Org.pem");
            ...
            using (StreamReader sr = File.OpenText(LicenseFileName))
            {
                ...
                _License = Newtonsoft.Json.JsonConvert.DeserializeObject<AppsLicense>(license);
        ...
        public static string GetLicenseFilePath()
        {
            ...
            AppsParameterRequest paramRequest = new AppsParameterRequest
            {
                AppsParameters = new List<AppsParameter> { 
                    new AppsParameter{ CategoryName = "LICENSE", ParameterName = "LicenseFilePath" }
                }
            };
            AppsParameterResponse paramResponse = RestHelper.RestPostObject<AppsParameterResponse, AppsParameterRequest>(svcUrl, paramRequest);
            if (paramResponse.Result == Result.OK)
                return paramResponse.AppsParameters[0].ParameterValue;
