...
namespace Org.Apps.SystemManager.Presentation.Helpers
{
    ...
    {
        public const string InvalidPasswordExceptionMessage = "Org.Apps.BaseDao.InvalidPasswordException";
        public const string NoDataFoundExceptionMessage = "Org.Apps.BaseDao.NoDataFoundException";
        public const string ExpiredPasswordExceptionMessage = "Org.Apps.BaseDao.PasswordExpiredException";
