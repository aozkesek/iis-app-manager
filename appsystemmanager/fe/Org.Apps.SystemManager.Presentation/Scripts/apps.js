...
$.fn.extend(
{
    ...
    Apps_FillOption: function (postTo, postData) {
    ...
    Apps_OpenModalDialog: function (paramTitle, paramUrl, paramWidth, paramHeight) {
    ...
    Apps_SubmitTo: function (url, method) {
        var _this = $(this);
    ...
    Apps_AjaxDialog: function(title, height, width, url, closeButtonText, buttons) {
