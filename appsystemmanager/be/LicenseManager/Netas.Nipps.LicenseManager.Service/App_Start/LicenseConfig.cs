...
namespace Netas.Nipps.LicenseManager.Service
{
    ...
    {
        public static readonly string DllName = "Netas.Nipps.License.dll";
        
        private static readonly string _TypeName = "Netas.Nipps.License.Demo";
